...
const ANDROID_SPLASHES = [
    ...
    { source: 'drawable-port-mdpi-screen.png', target: 'drawable-mdpi/splash.png' },
    { source: 'drawable-port-hdpi-screen.png', target: 'drawable-hdpi/splash.png' },
    { source: 'drawable-port-xhdpi-screen.png', target: 'drawable-xhdpi/splash.png' },
    { source: 'drawable-port-xxhdpi-screen.png', target: 'drawable-xxhdpi/splash.png' },
    { source: 'drawable-port-xxxhdpi-screen.png', target: 'drawable-xxxhdpi/splash.png' }
];
